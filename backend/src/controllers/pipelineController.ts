...
class PipelineController {
	...
	private readonly baseUrl = `http://${process.env.OLLAMA_API_BASE}:${process.env.OLLAMA_PORT}`;
	private readonly chromaUrl = `http://${process.env.CHROMA_SERVER_HOST}:${process.env.CHROMA_SERVER_PORT}`;
